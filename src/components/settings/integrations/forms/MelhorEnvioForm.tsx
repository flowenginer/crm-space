...
import { Loader2, Check, X, ExternalLink, Package } from 'lucide-react';
import { useCompanySettings } from '@/hooks/useCompanySettings';
import { supabase } from '@/integrations/supabase/client';
import { toast } from 'sonner';

export function MelhorEnvioForm() {
    ...
    <div className="space-y-6">
      ...
      <div className="border-t pt-6 space-y-4">
        ...
        <ol className="list-decimal list-inside space-y-2 text-sm text-muted-foreground">
          ...
          <li>Adicione o token como secret <code className="bg-muted px-1.5 py-0.5 rounded text-xs">MELHOR_ENVIO_TOKEN</code> no Supabase</li>
      ...
      <div className="border-t pt-6 space-y-3">
        <h4 className="font-medium">Transportadoras Disponíveis:</h4>
