...
import { 
  ...
  ArrowUpDown, Info, Box, MapPin, DollarSign, Check
} from 'lucide-react';
...
export function ShippingQuotePanel() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[2fr_3fr] gap-6 max-w-7xl mx-auto">
      {/* Left Panel - Form */}
        ...
        <CardContent className="py-6 space-y-6">
          ...
          <div className="space-y-4">
            ...
            {volumes.map((volume, index) => (
              <div key={volume.id} className="p-3 bg-muted/50 rounded-lg space-y-3">
      ...
      {/* Right Panel - Results */}
      <div className="space-y-4">
        {/* Results Header - Show when we have results */}
          ...
          <CardContent className="py-4">
            ...
            {!hasCalculated && !isLoading && (
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <p className="text-sm text-muted-foreground/70 max-w-xs">
                  Preencha os dados de origem, destino e volume ao lado para ver as opções de frete disponíveis.
                </p>
              </div>
            )}
            ...
            {isLoading && (
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <p className="text-sm text-muted-foreground">Buscando melhores opções de frete...</p>
              </div>
            )}
