...
import { Boxes, Check, X, Building2, RefreshCw, Settings } from 'lucide-react';
import { useSuperAdminTenants } from '@/hooks/useSuperAdminTenants';
import { TenantSyncPanel } from '@/components/platform/TenantSyncPanel';
import {
  Select,
  SelectContent,
  SelectItem,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold">Módulos & Sincronização</h1>
          <p className="text-muted-foreground">
            Gerencie módulos e sincronize configurações entre tenants
          </p>
        </div>
      </div>
