...
export const SYSTEM_PERMISSIONS: PermissionCategory[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: 'reports.view_calls', name: 'Ver Ligações', description: 'Acessar seu próprio histórico de ligações' },
      { key: 'reports.view_calls_all', name: 'Ver Todas as Ligações', description: 'Ver histórico de ligações de todos os usuários' },
