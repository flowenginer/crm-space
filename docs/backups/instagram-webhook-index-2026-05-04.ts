// =============================================================================
// BACKUP - supabase/functions/instagram-webhook/index.ts
// =============================================================================
// Capturado em 2026-05-04 da versao 36 deployada no projeto Supabase
// lkxrmjqrzhaivviuuamp (CRM Space).
//
// O index.ts deployado foi substituido por um stub que retorna 503 enquanto
// dura a solicitacao de restauracao do CRM. Meta esta bloqueado, mas pausamos
// a edge mesmo assim para garantir que nada seja processado.
//
// PARA REVERTER:
//   1. Copiar TUDO abaixo deste header (a partir do `import { serve }`) para
//      supabase/functions/instagram-webhook/index.ts no repo, sobrescrevendo
//      o stub atual.
//   2. Redeploy via MCP do Supabase:
//        mcp__up-supa__deploy_edge_function({
//          project_id: 'lkxrmjqrzhaivviuuamp',
//          name: 'instagram-webhook',
//          entrypoint_path: 'index.ts',
//          verify_jwt: false,
//          files: [{ name: 'index.ts', content: <conteudo abaixo> }]
//        })
//   3. Confirmar com get_edge_function que a versao nova esta ACTIVE.
//   4. Atualizar PROGRESS.md anotando a reversao.
//
// Detalhes do pause: ver entrada de 2026-05-04 em PROGRESS.md.
// =============================================================================
