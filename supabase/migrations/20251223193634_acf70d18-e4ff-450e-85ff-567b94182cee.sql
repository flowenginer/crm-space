...
DROP FUNCTION IF EXISTS public.delete_tenant_by_super_admin(uuid);

-- Recriar função delete_tenant_by_super_admin com nomes corretos das tabelas
...
BEGIN
  ...
  -- Internal chat (nomes corretos das tabelas)
  ...
  DELETE FROM quick_messages WHERE tenant_id = p_tenant_id;
