...
-- Corrigir internal_notes_text: buscar da tabela 'internal_notes', não de 'messages'
-- A migration anterior buscava de messages com message_type = 'internal_note' (errado)
...
BEGIN
  ...
  SELECT
    ...
    -- CORRIGIDO: Notas internas da tabela 'internal_notes', não de 'messages'
    (
