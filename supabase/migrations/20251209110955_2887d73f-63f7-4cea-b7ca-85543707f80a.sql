-- Corrigir funções RPC para usar first_contact_at do contato em vez de created_at da conversa
-- Isso garante que os filtros de data mostrem novos leads (primeiro contato) e não conversas criadas

-- Atualizar get_all_conversation_counts para usar first_contact_at
...
-- Atualizar get_date_filter_counts para usar first_contact_at
