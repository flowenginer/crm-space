...
-- ============================================================
-- CORREÇÃO: Qualifica profiles.id para eliminar ambiguidade
-- com campo 'id' do RETURNS TABLE
-- ============================================================
...
-- Recria com profiles.id qualificado
...
DECLARE
  ...
  v_offset integer;
BEGIN
  -- Resolve tenant_id do usuário autenticado (qualificando profiles.id para evitar ambiguidade)
...
-- Garante permissão de execução para authenticated
