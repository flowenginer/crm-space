-- Fix: substituir sender_type (inexistente) por is_from_me na função search_conversations_report

-- Drop todas as versões existentes para evitar ambiguidade
...
-- Recria a função completa com is_from_me no lugar de sender_type
...
-- Re-concede permissão ao role authenticated
