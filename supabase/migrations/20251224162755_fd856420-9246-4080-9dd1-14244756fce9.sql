-- Corrigir o trigger handle_new_user para usar a tabela correta tenant_invitations
-- Esta correção é CRÍTICA e afeta a criação de usuários em TODOS os tenants
...
BEGIN
  ...
  ELSIF v_skip_auto_tenant THEN
    ...
    RETURN NEW;
  ELSE
    -- Try to find an invitation for this email (CORRIGIDO: usar tenant_invitations)
    ...
    IF v_invitation.id IS NOT NULL THEN
      ...
      -- Mark invitation as accepted (CORRIGIDO: usar tenant_invitations)
