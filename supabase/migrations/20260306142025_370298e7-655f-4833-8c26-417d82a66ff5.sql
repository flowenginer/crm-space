...
-- Fix search_conversations_report to use contact_tags instead of conversation_tags
-- This fixes the issue where tags added to contacts don't show in the report
