-- Remover a versão antiga da função que está causando conflito
-- A assinatura antiga: (uuid, uuid, uuid, text) RETURNS boolean
DROP FUNCTION IF EXISTS public.transfer_conversation(uuid, uuid, uuid, text);

-- Garantir que a versão correta exista (5 parâmetros, RETURNS jsonb)
