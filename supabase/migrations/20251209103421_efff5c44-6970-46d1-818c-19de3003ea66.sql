-- Fix get_all_conversation_counts to handle 'no_channel' as text
CREATE OR REPLACE FUNCTION public.get_all_conversation_counts(
  p_user_id uuid DEFAULT NULL,
  p_timezone text DEFAULT 'America/Sao_Paulo',
  p_department_id uuid DEFAULT NULL,
  p_agent_id uuid DEFAULT NULL,
  p_channel_id text DEFAULT NULL,  -- Changed from uuid to text to handle 'no_channel'
...
-- Fix get_date_filter_counts to handle 'no_channel' as text
CREATE OR REPLACE FUNCTION public.get_date_filter_counts(
  p_timezone text DEFAULT 'America/Sao_Paulo',
  p_department_id uuid DEFAULT NULL,
  p_agent_id uuid DEFAULT NULL,
  p_channel_id text DEFAULT NULL,  -- Changed from uuid to text
  p_origin text DEFAULT NULL,
  p_status_filter text DEFAULT 'active'
)
RETURNS jsonb
